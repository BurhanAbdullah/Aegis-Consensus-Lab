...
ax.set_title(
    "Predictive Governance Survivability Landscape",
    fontsize=15,
    pad=15
)
...
plt.savefig(
    "experiments/predictive_heatmap_publication.png",
    dpi=500,
    bbox_inches="tight"
)

plt.savefig(
    "experiments/predictive_heatmap_publication.pdf",
    bbox_inches="tight"
)

print("Generated predictive heatmap.")
