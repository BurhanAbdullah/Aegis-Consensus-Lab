...
REQUIRED_TEXT = [
    ...
    "research/transactions_rebuild/TRANSACTIONS_RELEASE_PROVENANCE_MANIFEST_v2.md",
]
...
def main() -> None:
    manifest = ROOT / "research/transactions_rebuild/TRANSACTIONS_RELEASE_PROVENANCE_MANIFEST_v2.md"
